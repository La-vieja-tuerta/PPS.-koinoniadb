...
<div style='background-color: #aaaaaa; padding: 20px'>
    <div style='background-color: white;max-width: 60%; margin: auto; padding: 5px'>
        <div>
            <h2>{$nombre} Quiere Ser Voluntario! desde Ayudarg</h2>
        </div>
        <div>
        ...
        <div>
            <span style='font-weight: bold'>Quiero Ser Voluntario</span>
        </div>

        <div>
            <div style='border: dotted 1px #3c3c3c; padding:10px;margin-top:15px;'>{$mensaje}</div>
        </div>
    </div>
</div>